  ...
  return PlcProject(
    ...
    tags: [
      ...
      PlcTag(
          ...
          value: false,
          ioType: 'SimulatedInput',
          description: 'Stop pushbutton NC'),
      PlcTag(
          name: 'EStop_OK',
      ...
      PlcTag(
          name: 'Overload_OK',
          path: 'Inputs/Overload_OK',
          dataType: 'BOOL',
          value: true,
          ioType: 'SimulatedInput',
          description: 'Thermal overload healthy'),
      PlcTag(
          name: 'Motor_Latch',
          path: 'Internal/Motor_Latch',
          dataType: 'BOOL',
          value: false,
          ioType: 'Internal',
          description: 'Internal seal-in latch'),
      PlcTag(
          name: 'Motor_Run',
        ...
        rungs: [
          buildRung(
            ...
            main: [
              ...
              ldOte('Motor_Latch', 'Seal-in latch'),
            ],
            branches: [
              BranchSpec(
                  startIndex: 0,
                  endIndex: 0,
                  nodes: [ldXic('Motor_Latch', 'Seal-in aux')]),
            ],
          ),
          buildRung(
            index: 1,
            ...
            main: [
              ldXic('Motor_Latch', 'Latched'),
              ldXic('EStop_OK', 'E-Stop healthy'),
              ldXic('Overload_OK', 'Overload healthy'),
              ldOte('Motor_Run', 'Starter coil'),
            ],
          ),
        ],
      ),
    ...
    tasks: [
      PlcTask(
          name: 'MainContinuousTask',
          type: 'Continuous',
          periodMs: 100,
          programNames: ['MotorControl_LD']),
    ],
    hmis: [
      HmiScreenDef(
        id: 'hmi_motor',
        ...
        components: [
          ...
          HmiComponent(
              id: 'c5',
              title: 'Overload Healthy',
              type: 'ToggleSwitch',
              tagBinding: 'Overload_OK',
              gridSpanWidth: 1,
              accentColor: 'amber'),
          HmiComponent(
              id: 'c6',
...
PlcProject legacyTankProject() => PlcProject(
      id: 'proj_tank',
      ...
      tasks: [
        PlcTask(
            name: 'ProcessLoopTask',
            type: 'Continuous',
            periodMs: 100,
            programNames: ['TankLevel_FBD']),
      ],
      hmis: [
        HmiScreenDef(
          id: 'hmi_tank',
...
PlcProject legacyStReactorProject() => PlcProject(
      id: 'proj_st_reactor',
      ...
      tags: [
        PlcTag(
            ...
            ioType: 'SimulatedInput',
            engineeringUnits: '°C',
            description: 'Reactor temperature process value'),
        PlcTag(
            name: 'Temp_SP',
            path: 'Internal/Temp_SP',
            dataType: 'FLOAT64',
            value: 75.0,
            ioType: 'Internal',
            engineeringUnits: '°C',
        ...
        PlcTag(
            name: 'Temp_Ambient',
            path: 'Internal/Temp_Ambient',
            dataType: 'FLOAT64',
            value: 20.0,
            ioType: 'Internal',
            engineeringUnits: '°C',
            description:
                'Ambient temperature the reactor drifts toward with no actuation'),
        PlcTag(
            name: 'Auto_Mode',
            path: 'Inputs/Auto_Mode',
            dataType: 'BOOL',
            value: true,
            ioType: 'SimulatedInput',
            description: 'Auto / Manual selector switch'),
        PlcTag(
            name: 'Heat_Cmd',
            ...
            value: false,
            ioType: 'SimulatedOutput',
            description: 'Heater element contactor'),
        PlcTag(
            name: 'Cool_Cmd',
        ...
        PlcTag(
            name: 'Alarm_High',
            path: 'Outputs/Alarm_High',
            dataType: 'BOOL',
            value: false,
            ioType: 'SimulatedOutput',
            description: 'High temperature alarm (>95°C)'),
        PlcTag(
            name: 'Alarm_Low',
            path: 'Outputs/Alarm_Low',
            dataType: 'BOOL',
            value: false,
            ioType: 'SimulatedOutput',
            description: 'Low temperature alarm (<5°C)'),
        PlcTag(
            name: 'Reactor_Ready',
            path: 'Outputs/Reactor_Ready',
            dataType: 'BOOL',
            value: false,
            ioType: 'SimulatedOutput',
            description: 'Reactor at setpoint ±2°C'),
      ],
      structDefs: [],
      simRules: [
        ...
        SimRule(
            id: 'sim2',
            name: 'Ambient pull (first-order lag)',
            targetPath: 'Temp_PV',
            behavior: 'firstOrderLag',
            sourcePath: 'Temp_Ambient',
            tauSec: 30,
            minValue: 0,
            maxValue: 150),
      ],
      programs: [
        PlcProgram(
          ...
          description:
              'Reactor temperature on/off deadband control with alarms',
          stSource:
              r'''// IEC 61131-3 Structured Text — Reactor Temperature Controller
...
PlcProject legacyLdConveyorProject() => PlcProject(
      id: 'proj_ld_conveyor',
      ...
      tags: [
        ...
        PlcTag(
            ...
            value: true,
            ioType: 'SimulatedInput',
            description: 'E-Stop healthy NC contact (TRUE = healthy)'),
        PlcTag(
            name: 'Manual_Jog',
            path: 'Inputs/Manual_Jog',
            dataType: 'BOOL',
            value: false,
            ioType: 'SimulatedInput',
            description: 'Manual jog pushbutton'),
        PlcTag(
            name: 'Belt_Latch',
            path: 'Internal/Belt_Latch',
            dataType: 'BOOL',
            value: false,
            ioType: 'Internal',
            description: 'Belt motor seal-in latch'),
        PlcTag(
            name: 'Belt_Motor',
            path: 'Outputs/Belt_Motor',
            dataType: 'BOOL',
            value: false,
            ioType: 'SimulatedOutput',
            description: 'Belt drive motor contactor'),
        PlcTag(
            name: 'Photo_Eye',
            path: 'Inputs/Photo_Eye',
            dataType: 'BOOL',
            value: false,
            ioType: 'SimulatedInput',
            description: 'Part detection photo eye'),
        PlcTag(
            name: 'Belt_Jammed',
            path: 'Outputs/Belt_Jammed',
            dataType: 'BOOL',
            value: false,
            ioType: 'SimulatedOutput',
            description: 'Belt jam alarm output'),
        PlcTag(
            name: 'Part_Present',
            path: 'Internal/Part_Present',
            dataType: 'BOOL',
            value: false,
            ioType: 'Internal',
            description: 'Part present internal flag'),
        PlcTag(
          name: 'JamTimer',
          ...
          ioType: 'Internal',
          description:
              'On-delay timer: belt running with no part for 5s trips jam alarm',
        ),
      ],
      structDefs: [],
      simRules: [
        SimRule(
            id: 'sim0',
            name: 'Photo eye blips while belt runs',
            targetPath: 'Photo_Eye',
            behavior: 'pulse',
            onMs: 2000,
            offMs: 2500,
            ...
            condition: [
              SimClause(
                  leftPath: 'Belt_Motor', comparator: '==', operand: 'true')
            ]),
      ],
      programs: [
        PlcProgram(
          ...
          language: 'LadderLogic',
          description:
              'Conveyor belt start/stop with E-Stop interlock and jam detection',
          rungs: [
            buildRung(
              index: 0,
              comment:
                  'Rung 0: Belt Start/Stop — E-Stop and Jam Alarm Interlocks',
              main: [
                ldXic('Start_PB', 'Start NO'),
                ldXio('Stop_PB', 'Stop NC'),
                ldXic('EStop', 'E-Stop healthy NC'),
                ldXio('Belt_Jammed', 'Jam interlock NC'),
                ldOte('Belt_Motor', 'Belt drive contactor'),
              ],
              branches: [
                BranchSpec(
                    startIndex: 0,
                    endIndex: 0,
                    nodes: [ldXic('Belt_Latch', 'Seal-in aux')]),
                BranchSpec(
                    startIndex: 0,
                    endIndex: 0,
                    nodes: [ldXic('Manual_Jog', 'Manual jog')]),
              ],
            ),
            buildRung(
              index: 1,
              ...
              main: [
                ldXic('Belt_Motor', 'Motor aux'),
                ldOtl('Belt_Latch', 'Latch set')
              ],
            ),
            buildRung(
              index: 2,
              ...
              main: [
                ldXic('Photo_Eye', 'Part detected NO'),
                ldOte('Part_Present', 'Part present flag')
              ],
            ),
            buildRung(
              index: 3,
              comment:
                  'Rung 3: Jam Detection — Belt Running With No Parts for 5 Seconds',
              main: [
                ldXic('Belt_Motor', 'Belt running'),
            ...
            buildRung(
              ...
              main: [
                ldXic('JamTimer.DN', 'Timer done'),
                ldOtl('Belt_Jammed', 'Latch jam alarm')
              ],
            ),
            ...
            buildRung(
              ...
              main: [
                ldXic('Photo_Eye', 'Part seen'),
                ldOtu('Belt_Jammed', 'Unlatch jam alarm')
              ],
            ),
          ],
        ),
      ...
      hmis: [
        HmiScreenDef(
          ...
          components: [
            ...
            HmiComponent(
                id: 'lc5',
                title: 'Belt Motor Running',
                type: 'LedIndicatorLight',
                tagBinding: 'Belt_Motor',
                gridSpanWidth: 1,
                accentColor: 'green'),
            HmiComponent(
                id: 'lc6',
...
PlcProject legacyFbdHvacProject() => PlcProject(
      id: 'proj_fbd_hvac',
      ...
      tags: [
        ...
        PlcTag(
            ...
            ioType: 'Internal',
            engineeringUnits: '°C',
            description: 'Comfort temperature setpoint'),
        PlcTag(
            name: 'Occupied',
        ...
        PlcTag(
            ...
            value: false,
            ioType: 'SimulatedInput',
            description: 'Window contact switch'),
        PlcTag(
            name: 'Fan_Cmd',
      ...
      simRules: [
        ...
        SimRule(
            ...
            condition: [
              SimClause(
                  leftPath: 'Heat_Cmd', comparator: '==', operand: 'false'),
              SimClause(
                  leftPath: 'Cool_Cmd', comparator: '==', operand: 'false')
            ]),
      ],
      programs: [
        PlcProgram(
          ...
          language: 'FunctionBlockDiagram',
          description:
              'HVAC zone control using AND/NOT/SUB/ADD/LT/GT signal flow gates',
          fbdBlocks: [
...
PlcProject legacySfcFillingProject() => PlcProject(
      id: 'proj_sfc_filling',
      ...
      tags: [
        PlcTag(
            name: 'Start_Cmd',
            path: 'Inputs/Start_Cmd',
            dataType: 'BOOL',
            value: false,
            ioType: 'SimulatedInput',
            description: 'Operator start command'),
        PlcTag(
            name: 'Bottle_Present',
            path: 'Inputs/Bottle_Present',
            dataType: 'BOOL',
            value: false,
            ioType: 'SimulatedInput',
            description: 'Bottle presence sensor'),
        PlcTag(
            name: 'Fill_Valve',
            path: 'Outputs/Fill_Valve',
            dataType: 'BOOL',
            value: false,
            ioType: 'SimulatedOutput',
            description: 'Filler valve solenoid'),
        PlcTag(
            name: 'Cap_Solenoid',
            path: 'Outputs/Cap_Solenoid',
            dataType: 'BOOL',
            value: false,
            ioType: 'SimulatedOutput',
            description: 'Capping solenoid'),
        PlcTag(
            name: 'Eject_Cyl',
            path: 'Outputs/Eject_Cyl',
            dataType: 'BOOL',
            value: false,
            ioType: 'SimulatedOutput',
            description: 'Ejection cylinder'),
        PlcTag(
            name: 'Fill_Level',
            path: 'Inputs/Fill_Level',
            dataType: 'FLOAT64',
            value: 0.0,
            ioType: 'SimulatedInput',
            engineeringUnits: '%',
            description: 'Bottle fill level sensor'),
        PlcTag(
            name: 'Filled_Count',
            path: 'Internal/Filled_Count',
            dataType: 'INT32',
            value: 0,
            ioType: 'Internal',
            description: 'Bottles filled counter'),
        PlcTag(
            name: 'Sequence_Running',
            path: 'Internal/Sequence_Running',
            dataType: 'BOOL',
            value: false,
            ioType: 'Internal',
            description: 'Sequence active flag'),
        PlcTag(
            name: 'Sfc_Step',
            path: 'Internal/Sfc_Step',
            dataType: 'INT32',
            value: 0,
            ioType: 'Internal',
            description: 'Current SFC step index (0–5)'),
        PlcTag(
            name: 'Step_Delay',
            path: 'Internal/Step_Delay',
            dataType: 'INT32',
            value: 0,
            ioType: 'Internal',
            description: 'Step hold-time scan counter'),
      ],
      structDefs: [],
      simRules: [
        SimRule(
            id: 'sim0',
            name: 'Bottle fills while valve open',
            targetPath: 'Fill_Level',
            behavior: 'integrate',
            ratePerSec: 8.0,
            minValue: 0,
            maxValue: 100,
        ...
        PlcProgram(
          ...
          sfcTransitions: [
            SfcTransition(
                ...
                fromStepId: 's0',
                toStepId: 's1',
                conditionSt: 'Start_Cmd'),
            SfcTransition(
                id: 't1',
                fromStepId: 's1',
                toStepId: 's2',
                conditionSt: 'Bottle_Present'),
            SfcTransition(
                id: 't2',
                fromStepId: 's2',
                toStepId: 's3',
                conditionSt: 'Fill_Level >= 95.0'),
            SfcTransition(
                id: 't3',
                fromStepId: 's3',
                toStepId: 's4',
                conditionSt: 'STEP_T >= 3000  (* cap press dwell *)'),
            SfcTransition(
                id: 't4',
                fromStepId: 's4',
                toStepId: 's5',
                conditionSt: 'STEP_T >= 2000  (* eject stroke *)'),
            SfcTransition(
                id: 't5',
                fromStepId: 's5',
                toStepId: 's1',
      ...
      tasks: [
        PlcTask(
            name: 'FillerSequenceTask',
            type: 'Periodic',
            periodMs: 200,
            programNames: ['BottleFill_SFC']),
      ],
      hmis: [
        HmiScreenDef(
          id: 'hmi_sfc_filling',
          ...
          components: [
            ...
            HmiComponent(
                ...
                title: 'Cap Solenoid',
                type: 'LedIndicatorLight',
                tagBinding: 'Cap_Solenoid',
                gridSpanWidth: 1,
                accentColor: 'amber'),
            HmiComponent(
                id: 'sf6',
                title: 'Eject Cylinder',
                type: 'LedIndicatorLight',
                tagBinding: 'Eject_Cyl',
                gridSpanWidth: 1,
                accentColor: 'red'),
            HmiComponent(
                id: 'sf7',
...
PlcProject legacySfcBatchMixProject() => PlcProject(
      ...
      tags: [
        ...
        PlcTag(
            name: 'Quality_OK',
            path: 'Inputs/Quality_OK',
            dataType: 'BOOL',
            value: true,
            ioType: 'SimulatedInput',
            description:
                'Batch quality accept (true = dispatch, false = reject)'),
        PlcTag(
            name: 'Temp_PV',
            path: 'Inputs/Temp_PV',
            dataType: 'FLOAT64',
            ...
            ioType: 'SimulatedInput',
            engineeringUnits: '°C',
            description: 'Mix tank temperature'),
        PlcTag(
            name: 'Fill_Level',
            path: 'Inputs/Fill_Level',
            dataType: 'FLOAT64',
            ...
            ioType: 'SimulatedInput',
            engineeringUnits: '%',
            description: 'Mix tank fill level'),
        PlcTag(
            name: 'Temp_SP',
            path: 'Internal/Temp_SP',
            dataType: 'FLOAT64',
        ...
        PlcTag(
            name: 'Reject_Count',
            path: 'Internal/Reject_Count',
            dataType: 'INT32',
            value: 0,
            ioType: 'Internal',
            description: 'Rejected batches'),
        PlcTag(
            name: 'Heater',
            path: 'Outputs/Heater',
            dataType: 'BOOL',
        ...
        PlcTag(
            ...
            value: false,
            ioType: 'SimulatedOutput',
            description: 'Mixer agitator'),
        PlcTag(
            name: 'Dispatch_Pump',
            path: 'Outputs/Dispatch_Pump',
            dataType: 'BOOL',
            value: false,
            ioType: 'SimulatedOutput',
            description: 'Dispatch transfer pump'),
        PlcTag(
            name: 'Drain_Valve',
            path: 'Outputs/Drain_Valve',
            dataType: 'BOOL',
            value: false,
            ioType: 'SimulatedOutput',
            description: 'Reject drain valve'),
      ],
      structDefs: [],
      simRules: [
        SimRule(
            ...
            maxValue: 95,
            condition: [
              SimClause(leftPath: 'Heater', comparator: '==', operand: 'true')
            ]),
        SimRule(
            id: 'sim1',
            name: 'Filling raises level',
            targetPath: 'Fill_Level',
            behavior: 'integrate',
            ratePerSec: 30.0,
            minValue: 0,
      ...
      programs: [
        PlcProgram(
          ...
          language: 'SequentialFunctionChart',
          description:
              'Batch mix sequence: parallel heat/fill fork-join, then quality-gated dispatch/reject',
          sfcSteps: [
            SfcStep(
                id: 's0',
                name: 'IDLE',
            ...
            SfcStep(
                id: 's4', name: 'FILL_DONE', actionSt: 'Fill_Valve := FALSE;'),
            SfcStep(id: 's5', name: 'MIXING', actionSt: 'Agitator := TRUE;'),
            SfcStep(
                id: 's6',
                name: 'DISPATCH',
                actionSt: 'Agitator := FALSE;\nDispatch_Pump := TRUE;'),
            SfcStep(
                id: 's7',
                name: 'REJECT',
                actionSt: 'Agitator := FALSE;\nDrain_Valve := TRUE;'),
          ...
          sfcTransitions: [
            ...
            SfcTransition(
                ...
                fromStepId: 's1',
                toStepId: 's2',
                conditionSt: 'Temp_PV >= Temp_SP'),
            SfcTransition(
                id: 't2',
                fromStepId: 's3',
                toStepId: 's4',
                conditionSt: 'Fill_Level >= Fill_Target'),
            SfcTransition(
                id: 'tj',
                fromStepId: '',
                toStepId: 's5',
            ...
            SfcTransition(
                ...
                fromStepId: 's5',
                toStepId: 's6',
                conditionSt: 'STEP_T >= 3000 AND Quality_OK'),
            SfcTransition(
                id: 't4',
                fromStepId: 's5',
                toStepId: 's7',
                conditionSt: 'STEP_T >= 3000 AND NOT Quality_OK'),
            SfcTransition(
                id: 't5',
                fromStepId: 's6',
                toStepId: 's8',
      ...
      tasks: [
        PlcTask(
            name: 'BatchSequenceTask',
            type: 'Periodic',
            periodMs: 200,
            programNames: ['BatchMix_SFC']),
      ],
      hmis: [
        HmiScreenDef(
          id: 'hmi_sfc_batchmix',
...
PlcProject legacyFbdPidTankLevelProject() => PlcProject(
      ...
      tags: [
        ...
        PlcTag(
            name: 'Valve_CV',
            path: 'Outputs/Valve_CV',
            dataType: 'FLOAT64',
            value: 0.0,
            ioType: 'SimulatedOutput',
            engineeringUnits: '%',
            description: 'Inlet valve control variable (PID output)'),
      ],
      structDefs: [],
      simRules: [
        ...
        SimRule(
            id: 'sim0',
            name: 'Inflow scaled by valve position',
            targetPath: 'Level_PV',
            behavior: 'integrate',
            ratePerSec: 6.0,
            sourcePath: 'Valve_CV',
        ...
        SimRule(
            id: 'sim1',
            name: 'Constant outflow disturbance',
            targetPath: 'Level_PV',
            behavior: 'integrate',
            ratePerSec: -1.0,
            minValue: 0,
...
PlcProject legacyFbdBatchCounterProject() => PlcProject(
...
PlcProject legacyFbdPulseOutputProject() => PlcProject(
...
PlcProject legacyCascadeTanksProject() => PlcProject(
      ...
      tags: [
        PlcTag(
            name: 'Feed_Valve',
            path: 'Internal/Feed_Valve',
            dataType: 'FLOAT64',
            value: 60.0,
            ioType: 'Internal',
            engineeringUnits: '%',
            description:
                'Manipulated feed valve opening driving inflow into Tank A'),
        PlcTag(
            name: 'Tank_A_Level',
            path: 'Inputs/Tank_A_Level',
            dataType: 'FLOAT64',
            value: 10.0,
            ioType: 'SimulatedInput',
            engineeringUnits: '%',
            description: 'Upstream tank level'),
        PlcTag(
            name: 'Transfer_Line',
            path: 'Internal/Transfer_Line',
            dataType: 'FLOAT64',
            value: 10.0,
            ioType: 'Internal',
            engineeringUnits: '%',
            description:
                'Transport-delayed signal in the pipe carrying Tank A level to Tank B (deadTime of Tank_A_Level)'),
        PlcTag(
            name: 'Tank_B_Level',
            path: 'Inputs/Tank_B_Level',
            dataType: 'FLOAT64',
            value: 10.0,
            ioType: 'SimulatedInput',
            engineeringUnits: '%',
            description:
                'Downstream tank level, lags Tank A by the transport delay'),
      ],
      structDefs: [],
      simRules: [
        ...
        SimRule(
            id: 'sim0',
            name: 'Tank A inflow scaled by Feed_Valve',
            targetPath: 'Tank_A_Level',
            behavior: 'integrate',
            ratePerSec: 4.0,
            sourcePath: 'Feed_Valve',
            refValue: 100.0,
            minValue: 0,
            maxValue: 100),
        ...
        SimRule(
            id: 'sim2',
            name: 'Transfer line transport delay',
            targetPath: 'Transfer_Line',
            behavior: 'deadTime',
            sourcePath: 'Tank_A_Level',
            tauSec: 3.0,
            minValue: 0,
            maxValue: 100),
        ...
        SimRule(
            id: 'sim3',
            name: 'Tank B inflow scaled by Transfer Line',
            targetPath: 'Tank_B_Level',
            behavior: 'integrate',
            ratePerSec: 4.0,
            sourcePath: 'Transfer_Line',
            refValue: 100.0,
            minValue: 0,
            maxValue: 100),
        ...
        PlcProgram(
          ...
          fbdBlocks: [
            FbdBlock(
                ...
                type: 'TAG_INPUT',
                title: 'Feed Valve',
                tagBinding: 'Feed_Valve',
                x: 50,
                y: 80),
            FbdBlock(
                id: 'k_out',
                type: 'TAG_OUTPUT',
                title: 'Feed Valve Monitor',
                tagBinding: 'Feed_Valve',
                x: 320,
                y: 80),
          ],
      ...
      tasks: [
        PlcTask(
            name: 'CascadeMonitorTask',
            type: 'Continuous',
            periodMs: 500,
            programNames: ['CascadeMonitor_FBD']),
      ],
      hmis: [
        HmiScreenDef(
...
//
// This project also hosts the custom-function-block demo: a user-defined
// `Hysteresis` FB (native ST body, see `fbDefinitions` below) watches
// Level_Filtered and drives a High-Level Alarm with a 40-60% deadband, in
// its own FBD network alongside the pre-existing Fill_Valve monitor. The
// FB's internal `Q` var is the headline: it persists in the instance's
// struct tag across scans, so the alarm doesn't chatter when the noisy,
// lag-filtered level sits inside the deadband - see
// test/hysteresis_fb_demo_test.dart for the exact set/reset/hold proof.
PlcProject legacyNoisyLevelProject() {
  ...
  final scratchProj = PlcProject(
    id: '_scratch_hysteresis',
    name: '_scratch_hysteresis',
  ...
  return PlcProject(
    ...
    tags: [
      PlcTag(
          name: 'Fill_Valve',
          path: 'Internal/Fill_Valve',
          dataType: 'FLOAT64',
          value: 55.0,
          ioType: 'Internal',
          engineeringUnits: '%',
          description:
              'Manipulated fill valve opening driving inflow into the tank'),
      PlcTag(
          name: 'Tank_Level',
          path: 'Inputs/Tank_Level',
          dataType: 'FLOAT64',
          value: 20.0,
          ioType: 'SimulatedInput',
          engineeringUnits: '%',
          description:
              'Clean (true) tank level, driven by Fill_Valve minus a constant outflow'),
      PlcTag(
          name: 'Level_Meas',
          ...
          engineeringUnits: '%',
          description:
              'Raw noisy sensor reading of Tank_Level (measurement noise behaviour)'),
      PlcTag(
          name: 'Level_Filtered',
          path: 'Inputs/Level_Filtered',
          dataType: 'FLOAT64',
          value: 20.0,
          ioType: 'SimulatedInput',
          engineeringUnits: '%',
          description: 'First-order-lag-filtered reading of Level_Meas'),
      PlcTag(
        name: 'LevelAlarmHyst',
        path: 'Internal/LevelAlarmHyst',
        dataType: 'Hysteresis',
        value: defaultValueFor(scratchProj, 'Hysteresis', 0),
        ioType: 'Internal',
        description:
            'Custom function block instance: High-Level Alarm hysteresis (60% set / 40% reset)',
      ),
      PlcTag(
          name: 'Level_Alarm',
          path: 'Outputs/Level_Alarm',
          dataType: 'BOOL',
          value: false,
          ioType: 'SimulatedOutput',
          description:
              'High-level alarm with hysteresis deadband around Level_Filtered (custom Hysteresis FB)'),
    ],
    structDefs: [],
    simRules: [
      ...
      SimRule(
          id: 'sim0',
          name: 'Tank inflow scaled by Fill_Valve',
          targetPath: 'Tank_Level',
          behavior: 'integrate',
          ratePerSec: 3.0,
          sourcePath: 'Fill_Valve',
          refValue: 100.0,
          minValue: 0,
          maxValue: 100),
      ...
      SimRule(
          id: 'sim2',
          name: 'Level measurement noise',
          targetPath: 'Level_Meas',
          behavior: 'noise',
          sourcePath: 'Tank_Level',
          targetValue: 2.5,
          minValue: 0,
          maxValue: 100),
      ...
      SimRule(
          id: 'sim3',
          name: 'Level measurement filter',
          targetPath: 'Level_Filtered',
          behavior: 'firstOrderLag',
          sourcePath: 'Level_Meas',
          tauSec: 1.5,
          minValue: 0,
          maxValue: 100),
    ],
    programs: [
      // Network 0 is sim-driven (the integrate/noise/firstOrderLag rules above
      // do all the work) - a trivial pass-through monitor of Fill_Valve so the
      // project has a real Continuous task to run, mirroring how other
      // sim-only demos (e.g. Cascade Tanks) wire a task. Network 1 is the
      // custom-function-block showcase: a `Hysteresis` FB instance
      // (LevelAlarmHyst) watches Level_Filtered against CONST High/Low
      // thresholds and drives Level_Alarm, with its internal `Q` var
      // persisting across scans through the deadband.
      PlcProgram(
        name: 'NoisyLevelMonitor_FBD',
        language: 'FunctionBlockDiagram',
        description:
            'Network 0: pass-through monitor of Fill_Valve (sim-driven demo). '
            'Network 1: High-Level Alarm driven by a custom Hysteresis function '
            'block instance (LevelAlarmHyst) with a 40-60% deadband around Level_Filtered.',
        fbdBlocks: [
          FbdBlock(
              id: 'k_in',
              type: 'TAG_INPUT',
          ...
          FbdBlock(
              id: 'h_pv',
              type: 'TAG_INPUT',
              title: 'Level Filtered',
              tagBinding: 'Level_Filtered',
              x: 50,
              y: 200,
              network: 1),
          FbdBlock(
          ...
          FbdBlock(
              id: 'h_hyst',
              type: 'Hysteresis',
              title: 'Level Alarm Hysteresis',
              tagBinding: 'LevelAlarmHyst',
              x: 320,
              y: 280,
              network: 1),
          FbdBlock(
    ...
    tasks: [
      PlcTask(
          name: 'NoisyLevelMonitorTask',
          type: 'Continuous',
          periodMs: 500,
          programNames: ['NoisyLevelMonitor_FBD']),
    ],
    hmis: [
      HmiScreenDef(
        id: 'hmi_noisy_level',
        ...
        components: [
          HmiComponent(
              id: 'nl1',
              title: 'Tank Level (%) - Clean',
              type: 'TankGraphicDisplay',
              tagBinding: 'Tank_Level',
              gridSpanWidth: 4,
              accentColor: 'cyan'),
          HmiComponent(
              id: 'nl2',
              title: 'Level Measured (%) - Noisy',
              type: 'DigitalGaugeDisplay',
          ...
          HmiComponent(
              id: 'nl4',
              title: 'HIGH LEVEL ALARM (Hysteresis FB)',
              type: 'StatusPillDisplay',
              tagBinding: 'Level_Alarm',
              gridSpanWidth: 4,
              accentColor: 'red'),
...
PlcProject legacyMimoTwoZoneProject() => PlcProject(
      ...
      tags: [
        PlcTag(
            name: 'Heater_A',
            path: 'Outputs/Heater_A',
            dataType: 'FLOAT64',
            value: 0.0,
            ioType: 'SimulatedOutput',
            engineeringUnits: '%',
            description: 'Zone A heater power command (decoupler output)'),
        PlcTag(
            name: 'Heater_B',
            path: 'Outputs/Heater_B',
            dataType: 'FLOAT64',
            value: 0.0,
            ioType: 'SimulatedOutput',
            engineeringUnits: '%',
            description: 'Zone B heater power command (decoupler output)'),
        PlcTag(
            name: 'Temp_A',
            path: 'Inputs/Temp_A',
            dataType: 'FLOAT64',
            ...
            ioType: 'SimulatedInput',
            engineeringUnits: '°C',
            description: 'Zone A temperature process value'),
        PlcTag(
            name: 'Temp_B',
            path: 'Inputs/Temp_B',
            dataType: 'FLOAT64',
            ...
            ioType: 'SimulatedInput',
            engineeringUnits: '°C',
            description: 'Zone B temperature process value'),
        PlcTag(
            name: 'SP_A',
            path: 'Internal/SP_A',
            dataType: 'FLOAT64',
            ...
            ioType: 'Internal',
            engineeringUnits: '°C',
            description: 'Zone A temperature setpoint'),
        PlcTag(
            name: 'SP_B',
            path: 'Internal/SP_B',
            dataType: 'FLOAT64',
            ...
            ioType: 'Internal',
            engineeringUnits: '°C',
            description: 'Zone B temperature setpoint'),
        PlcTag(
            name: 'Amb',
            path: 'Internal/Amb',
            dataType: 'FLOAT64',
            ...
            ioType: 'Internal',
            engineeringUnits: '°C',
            description: 'Ambient temperature both zones lose heat toward'),
        PlcTag(
            name: 'u_A',
            path: 'Internal/u_A',
            dataType: 'FLOAT64',
            ...
            ioType: 'Internal',
            engineeringUnits: '%',
            description: 'Zone A PID output before the static decoupler'),
        PlcTag(
            name: 'u_B',
            path: 'Internal/u_B',
            dataType: 'FLOAT64',
            ...
            ioType: 'Internal',
            engineeringUnits: '%',
            description: 'Zone B PID output before the static decoupler'),
      ],
      structDefs: [],
      simRules: [
        // Temp_A
