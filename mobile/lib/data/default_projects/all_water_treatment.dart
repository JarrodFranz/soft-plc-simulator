  ...
  return PlcProject(
    ...
    tags: [
      ...
      PlcTag(
          ...
          description: 'Pump start pushbutton'),
      PlcTag(
          name: 'Stop_PB',
          path: 'Inputs/Stop_PB',
          dataType: 'BOOL',
          value: false,
          ioType: 'SimulatedInput',
          description: 'Pump stop pushbutton'),
      PlcTag(
          name: 'EStop',
          path: 'Inputs/EStop',
          dataType: 'BOOL',
      ...
      PlcTag(
          name: 'Pump_Latch',
          path: 'Internal/Pump_Latch',
          dataType: 'BOOL',
          value: false,
          ioType: 'Internal',
          description: 'Pump seal-in latch'),
      PlcTag(
          name: 'Pump_Motor',
          path: 'Outputs/Pump_Motor',
          dataType: 'BOOL',
          value: false,
          ioType: 'SimulatedOutput',
          description: 'Main pump motor contactor'),
      // Process values (FBD)
      PlcTag(
          name: 'Turbidity_PV',
          path: 'Inputs/Turbidity_PV',
          dataType: 'FLOAT64',
          value: 8.5,
          ioType: 'SimulatedInput',
          engineeringUnits: 'NTU',
          description: 'Raw water turbidity sensor'),
      PlcTag(
          name: 'Turbidity_SP',
          path: 'Internal/Turbidity_SP',
          dataType: 'FLOAT64',
          value: 5.0,
          ioType: 'Internal',
          engineeringUnits: 'NTU',
          description: 'Max turbidity setpoint'),
      PlcTag(
          name: 'Level_PV',
          ...
          ioType: 'SimulatedInput',
          engineeringUnits: '%',
          description: 'Clear water reservoir level'),
      PlcTag(
          name: 'Flow_PV',
          path: 'Inputs/Flow_PV',
          dataType: 'FLOAT64',
          ...
          description: 'Treated water flow rate'),
      ...
      PlcTag(
          name: 'Turbidity_Below_SP',
          path: 'Internal/Turbidity_Below_SP',
          dataType: 'BOOL',
          value: false,
          ioType: 'Internal',
          description: 'Turbidity within setpoint (network 0 result)'),
      PlcTag(
          name: 'Level_Above_Min',
          path: 'Internal/Level_Above_Min',
          dataType: 'BOOL',
          value: false,
          ioType: 'Internal',
          description: 'Reservoir level above minimum (network 0 result)'),
      PlcTag(
          name: 'Quality_OK',
          path: 'Internal/Quality_OK',
          dataType: 'BOOL',
          value: false,
          ioType: 'Internal',
          description: 'Water quality within spec'),
      // ST supervisor outputs
      PlcTag(
          name: 'Treat_Dosing',
          path: 'Outputs/Treat_Dosing',
          dataType: 'BOOL',
          value: false,
          ioType: 'SimulatedOutput',
      ...
      PlcTag(
          name: 'System_Ready',
          path: 'Internal/System_Ready',
          dataType: 'BOOL',
          value: false,
          ioType: 'Internal',
          description: 'All permissives healthy'),
      PlcTag(
          name: 'Alarm_Active',
          ...
          value: false,
          ioType: 'SimulatedOutput',
          description: 'System alarm beacon'),
      // SFC backwash sequence
      PlcTag(
          name: 'Backwash_Active',
          path: 'Internal/Backwash_Active',
          dataType: 'BOOL',
          value: false,
          ioType: 'Internal',
          description: 'Filter backwash mode active'),
      PlcTag(
          name: 'Backwash_Valve',
          path: 'Outputs/Backwash_Valve',
          dataType: 'BOOL',
          value: false,
          ioType: 'SimulatedOutput',
          description: 'Backwash header valve'),
      PlcTag(
          name: 'Backwash_Pump',
          path: 'Outputs/Backwash_Pump',
          dataType: 'BOOL',
          value: false,
          ioType: 'SimulatedOutput',
          description: 'Backwash pump'),
      PlcTag(
        name: 'BackwashTimer',
        ...
        ioType: 'Internal',
        description:
            'On-delay timer: 30s backwash cycle on sustained high turbidity',
      ),
      // Showcase array tag
      PlcTag(
        name: 'Recipe_Steps',
    ...
    simRules: [
      ...
      SimRule(
          id: 'sim0',
          name: 'Dosing clears turbidity',
          targetPath: 'Turbidity_PV',
          behavior: 'integrate',
          ratePerSec: -0.24,
          minValue: 0.5,
          maxValue: 20,
          condition: [
            SimClause(
                leftPath: 'Treat_Dosing', comparator: '==', operand: 'true')
          ]),
      ...
      SimRule(
          ...
          condition: [
            SimClause(
                leftPath: 'Pump_Motor', comparator: '==', operand: 'true'),
            SimClause(
                leftPath: 'Treat_Dosing', comparator: '==', operand: 'false'),
          ]),
      // Reservoir level drops while pumping (mirrors: pumpRun && level>0 -> -0.15/scan)
      SimRule(
          id: 'sim2',
          name: 'Level drops while pumping',
          targetPath: 'Level_PV',
          behavior: 'integrate',
          ratePerSec: -0.3,
          minValue: 0,
      ...
      SimRule(
          ...
          condition: [
            SimClause(
                leftPath: 'Pump_Motor', comparator: '==', operand: 'false')
          ]),
      ...
      SimRule(
          id: 'sim5',
          name: 'Flow drops to zero while stopped',
          targetPath: 'Flow_PV',
          behavior: 'ramp',
          ratePerSec: 84.0,
          targetValue: 0.0,
    ...
    programs: [
      ...
      PlcProgram(
        ...
        description:
            'Safety supervisor: permissive checks, alarms, quality assessment',
...
System_Ready := Pump_Motor AND Quality_OK AND NOT Alarm_Active;''',
      ...
      PlcProgram(
        ...
        description:
            'Main pump start/stop seal-in with E-Stop and quality interlock',
        rungs: [
          buildRung(
            index: 0,
            ...
            branches: [
              BranchSpec(
                  startIndex: 0,
                  endIndex: 0,
                  nodes: [ldXic('Pump_Latch', 'Seal-in')]),
            ],
          ),
          buildRung(
            index: 1,
            ...
            main: [
              ldXic('Pump_Motor', 'Motor aux'),
              ldOtl('Pump_Latch', 'Latch set')
            ],
          ),
          buildRung(
            index: 2,
            comment:
                'Rung 2: Chemical Dosing Interlock — Dose When Quality Fails',
            main: [
          ...
          buildRung(
            index: 3,
            comment:
                'Rung 3: Backwash TON — High Turbidity Triggers Backwash Timer',
            main: [
              ldXio('Quality_OK', 'Quality not OK NC'),
              ldXic('Pump_Motor', 'Pump running'),
          ...
          buildRung(
            ...
            main: [
              ldXic('BackwashTimer.DN', 'Timer done'),
              ldOte('Backwash_Active', 'Backwash active')
            ],
          ),
        ],
      ),
      ...
      PlcProgram(
        ...
        description:
            'Water quality gate logic using LT/GT/AND signal flow gates, across 2 networks',
        fbdNetworks: [
          FbdNetwork(
              comment:
                  'Thresholds — turbidity vs. setpoint, level vs. minimum'),
          FbdNetwork(
              comment:
                  'Quality gate & output — AND the threshold results, write Quality_OK'),
        ],
        fbdBlocks: [
        ...
        fbdWires: [
          ...
          FbdWire(
              ...
              fromPin: 'OUT',
              toBlockId: 'wf_lt',
              toPin: 'IN1'), // Turbidity_PV
          FbdWire(
              fromBlockId: 'wf_i2',
              fromPin: 'OUT',
              toBlockId: 'wf_lt',
              toPin: 'IN2'), // Turbidity_SP
          FbdWire(
              fromBlockId: 'wf_i3',
              fromPin: 'OUT',
              toBlockId: 'wf_gt',
      ...
      PlcProgram(
        ...
        sfcSteps: [
          ...
          SfcStep(
              id: 'bw1',
              name: 'OPEN_BACKWASH_VALVE',
              actionSt:
                  'Backwash_Valve := TRUE;\n// Allow 5s for valve to open'),
          SfcStep(
              id: 'bw2',
              name: 'BACKWASH_PUMPING',
        ...
        sfcTransitions: [
          SfcTransition(
              ...
              fromStepId: 'bw0',
              toStepId: 'bw1',
              conditionSt: 'Backwash_Active'),
          SfcTransition(
              id: 'bt1',
              fromStepId: 'bw1',
              toStepId: 'bw2',
              conditionSt: 'STEP_T >= 5000  (* valve open dwell *)'),
          SfcTransition(
              id: 'bt2',
              fromStepId: 'bw2',
              toStepId: 'bw3',
              conditionSt:
                  'Quality_OK OR STEP_T >= 30000  (* quality recovers, else 30s flush cap *)'),
          SfcTransition(
              id: 'bt3',
              fromStepId: 'bw3',
              toStepId: 'bw4',
              conditionSt: 'STEP_T >= 10000  (* rinse cycle *)'),
          SfcTransition(
              id: 'bt4',
              fromStepId: 'bw4',
              toStepId: 'bw0',
              conditionSt: 'NOT Backwash_Active'),
        ],
      ),
    ],
    tasks: [
      ...
      PlcTask(
          ...
          type: 'Continuous',
          periodMs: 100,
          programNames: ['Safety_ST', 'PumpControl_LD', 'WaterQuality_FBD']),
      PlcTask(
          name: 'BackwashTask',
          type: 'Periodic',
          periodMs: 1000,
          programNames: ['FilterBackwash_SFC']),
    ],
    hmis: [
      HmiScreenDef(
        id: 'hmi_all_water',
        ...
        components: [
          ...
          HmiComponent(
              ...
              title: 'Dosing Pump',
              type: 'LedIndicatorLight',
              tagBinding: 'Treat_Dosing',
              gridSpanWidth: 1,
              accentColor: 'amber'),
          HmiComponent(
              id: 'wt11',
              title: 'Backwash Active',
              type: 'LedIndicatorLight',
              tagBinding: 'Backwash_Active',
              gridSpanWidth: 1,
              accentColor: 'red'),
          HmiComponent(
              id: 'wt12',
