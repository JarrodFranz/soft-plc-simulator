...
PlcProject ladderConveyorLineProject() {
  ...
  return PlcProject(
    ...
    tags: [
      ...
      PlcTag(name: 'PartCtu', path: 'Counters/PartCtu', dataType: 'COUNTER', value: defaultValueFor(emptyScratchProject, 'COUNTER', 0), ioType: 'Internal', description: 'Count-up counter (preset 10): cumulative parts since power-up — rung 12 zeroes Part_Count, not this counter, so PartCtu.ACC never resets'),
