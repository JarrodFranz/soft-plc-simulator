...
- **ALL IEC 61131-3 Programming Languages Supported**:
  ...
  - **Sequential Function Chart (SFC)**: State Machine Chart Editor with Initial Steps, Steps, Transitions, ST Actions, Condition Autocomplete Palette, and alternative branching (if/else-if via ordered targeted transitions, flow-order layout with loop-back/forward GOTO chips — see [`docs/sfc-branching.md`](docs/sfc-branching.md)).
