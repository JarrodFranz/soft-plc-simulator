...
- **Status**: 🔄 **ACTIVE — analog rates + first-order lag + thermal showcase + a PID block (tank-level demo) + CTU/CTD/CTUD counters (batch-counter demo) shipped; auto-tune/coupled/dead-time models remain**
