...
- **Status**: 🔄 **ACTIVE — in-app pure-Dart OPC UA server v1 shipped (ADR-010; single app hosts, real-client E2E-proven); subscriptions/encryption + external-SCADA-client confirmation remain**
