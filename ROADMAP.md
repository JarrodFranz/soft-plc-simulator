...
- **Status**: 🔄 **ACTIVE — analog-driven rates + first-order lag + a closed-loop thermal showcase + a PID control block with a closed-loop tank-level demo shipped; auto-tune/coupled/dead-time models remain**
